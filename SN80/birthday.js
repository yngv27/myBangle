...
function drawBalloon(x,y) {
  g.setColor(Math.random()/2,Math.random()/2,Math.random()/2);
  g.fillEllipse(x,y,x+40,y+50);
  g.fillPoly([x+20, y+50, x+25,y+55, x+15, y+55], true);
}
...
let go = () => {
  ...
  g.setFontVector(64);
  g.setFontAlign(0,0);
  g.drawString("11:45",120,120);
  g.setFontVector(18);
  g.setColor("#80c0c0");
  g.drawString("Thu Dec 23", 120, 160);
  setTimeout(()=>{
    g.clear();
    g.setColor("#004020");
    ...
    g.setFontVector(18);
    g.setColor("#c0c0c0");
    g.drawString("Incoming message from:", 120, 100);
    g.setFontVector(36);
    g.drawString("Julie", 120, 160);
    
    setTimeout(()=>{
      //g.clear();
      g.clearRect(0,60,239,230);
      g.setColor("#f0f0f0");
      g.setFontVector(18);
      g.setColor("#c0c0c0");
      g.drawString("I'm sorry...", 120, 100);
      g.drawString("OUTGOING message TO:", 120, 120);
      g.setFontVector(36);
      g.drawString("Julie", 120, 160);
       ...
       setTimeout(()=>{
         ...
         for(let n=0; n < 160; n++) {
           drawBalloon(Math.random()*200, Math.random()* 200);
            g.setColor(0);
           g.drawString("HAPPY", 120, 104);
           g.drawString("BIRTHDAY!", 120, 136);
         }
       }, 5000);
    }, 4000);
  }, 5000);
