...
*/
let c=(function(){
  var bin=atob("g7KD6hBAw7KD6hAjA/APAIDqExAA8AMDg+qQAwPwAQCA6lMAcEfDCIPqkANAABC1A/ABA4HqAgQA8BgAY0BA6oIAQOpDEEDqQQBg8H4AwLIQvUIIQAAA8KowAvBVMgJDkwiSAALwzDID8DMzE0MYCRsBA/DwMwDwDzAYQ3BHAAA=");
  return {
    swdreq:E.nativeCall(39, "int(int,bool,bool)", bin),
    parity32:E.nativeCall(1, "int(int)", bin),
    rbitswap:E.nativeCall(83, "int(int)", bin),
  };
})();
swdreq=c.swdreq;
parity32=c.parity32;
