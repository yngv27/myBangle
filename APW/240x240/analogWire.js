...
function init() {
  ...
  */
  ...
  let drawClock = (d) => {
    ...
    g.fillCircle(120, 119, 4);
    g.setColor( _C.fgColor);
    g.drawPolyAA(rotatePoly(minHand, minAngle, 120, 119));
    g.drawPolyAA(rotatePoly(hrHand, hrAngle, 120, 119)); 
    g.drawCircleAA(120, 119, 4);
