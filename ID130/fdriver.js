...
// ID130 display pins
var RST=D12,CS=D11,DC=D31,PWR=D5,SCK=D30,MOSI=D29,BL=D5;
...
var g=Graphics.createArrayBuffer(135,240,bpp);
var pal;
switch(bpp){
...
g.flip=function(force){
  ...
  var c=g.winCmd;
  c[3]=g.x0+x1;c[5]=g.x0+x2; //0x2a params
  c[9]=g.y0+r.y1;c[11]=g.y0+  r.y2; // 0x2b params
