...
NRF24.prototype.init = function(rxAddr, txAddr) {
...
NRF24.prototype.setRXAddr = function(adr, pipe) {
...
NRF24.prototype.setTXAddr = function(adr /* 5 byte array*/) {
  this.setAddr(C.RX_ADDR_P0,adr);
  this.setAddr(C.TX_ADDR,adr);
};
/** Get the value of the given register (for internal use only) */
NRF24.prototype.getReg = function(reg) {
  return this.spi.send([C.R_REGISTER | reg, 0], this.CSN)[1];
};
/** Get the configured address. reg should be NRF24.C.TX_ADDR,C.RX_ADDR_P0..4 */
NRF24.prototype.getAddr = function(reg) {
...
NRF24.prototype.getDataPipe = function() {
...
NRF24.prototype.getData = function() {
...
NRF24.prototype.send = function(data/* array of length PAYLOAD */) {
...
NRF24.prototype.slaveHandler = function() {
...
NRF24.prototype.masterHandler = function() {
  while (this.getDataPipe()!==undefined) {
    var data = this.getData();
    for (var i in data) {
      var ch = data[i];
...
NRF24.prototype.sendString = function(cmd) {
...
NRF24.prototype.sendCommand = function(cmd, callback) {
