...
UC8179.prototype.round1 =function () {
  ...
  this.debug("round1");
  this.cmd(1 ,[7,7,0x3f,0x3f]); // [3,0,0x2f,0x2f,0xff]);
...
var opts ={spi: spi1, cs: D3, dc: D44, rst: D47, delay: D40, width: 400, height: 300}; //648, height: 480};
//*/
// Deskpal
spi1.setup({sck: D45, mosi: D47, baud: 2000000});
var opts ={spi: spi1, cs: D43, dc: D10, rst: D9, delay: D31, BUSY: D2, width: 400, height: 300}; //648, height: 480};
